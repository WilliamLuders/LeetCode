...
namespace LeetCodeTests
{
    public class Tests
    {
        ...
        [Test]
        public void Median_DoesNotAttemptToReadOutsideArray_WhenLowerMedianIsFoundAtEndOfArray()
        {
            var a = new int[] { 0, 0, 0, 3 };
            var b = new int[] { 3, 4, 4, 4 };

            Assert.That(
                () => P4_MergeMedian.IsMedian(3, a, b, out _),
                Throws.Nothing);
        }
        ...
        [Test]
        public void IsMedian_ReturnsTooLow_WhenSearchingInOtherArrayWouldGoAboveBounds()
        {
            var a = new int[] { 0, 1, 2, 4, 5, 6 };
            var b = new int[] { 8 };
        ...
        [Test]
        public void IsMedian_ReturnsTooHigh_WhenSearchingInOtherArrayWouldGoBelowBounds()
        {
            var a = new int[] { 0, 1, 2, 4, 5, 6 };
            var b = new int[] { 8 };

            Assert.That(
                P4_MergeMedian.IsMedian(5, a, b, out _),
                Is.EqualTo(MedianSearchResult.TooHigh));
        }
    }
}